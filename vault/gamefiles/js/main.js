...
function CheckBackground() {
  if (maxNuts >= 0 && maxNuts <= 9) {
    ...
    maxNuts >= 9999999999999999999 &&
    maxNuts <= 99999999999999999999
  ) {
    bgNum = 20;
  } else if (
    maxNuts >= 99999999999999999999 &&
    maxNuts <= 999999999999999999999
  ) {
    bgNum = 21;
...
function clickAnimation() {
  document.getElementById("amountAdded").innerHTML =
    "+" + kFormatter(clickDamage);
...
window.setInterval(function () {
  ...
  if (totalDamage >= 1) {
    window.setTimeout(function () {
      ...
      addedNuts.addEventListener(
        "animationend",
        function () {
          addedNuts.style.webkitAnimationName = "";
        },
        false,
      );
    }, 0);
...
function buy(building) {
  switch (building) {
    ...
    case "allUpgrade":
      ...
      if (allUpgrades < 5) {
        if (nuts >= allUpgradeCost) {
          ...
          nutUniversalDominationDamage =
            nutUniversalDominationDamage * 2 + prestigeGain;
    ...
    case "nutWorldControl":
      var nutWorldControlCost = Math.floor(
        330000000 * Math.pow(1.1, nutWorldControls),
      );
    ...
    case "nutGalacticReign":
      var nutGalacticReignCost = Math.floor(
        1500000000 * Math.pow(1.1, nutGalacticReigns),
      );
    ...
    case "nutTimeTravel":
      var nutTimeTravelCost = Math.floor(
        1000000000000 * Math.pow(1.1, nutTimeTravels),
      );
    ...
    case "nutUniversalDomination":
      var nutUniversalDominationCost = Math.floor(
        40000000000000 * Math.pow(1.1, nutUniversalDominations),
      );
    ...
    case "nutAfterlife":
      var nutAfterlifeCost = Math.floor(
        2000000000000000 * Math.pow(1.1, nutAfterlives),
      );
...
function ShowLevel() {
  ...
  document.getElementById("prestigeGain").innerHTML = round(
    (level * 10000 +
      nutKids * nutKidDamage +
      nutMen * nutManDamage +
      nutFarms * nutFarmDamage +
      nutFactories * nutFactoryDamage +
      nutBanks * nutBankDamage +
      nutEmpires * nutEmpireDamage +
      nutWorldControls * nutWorldControlDamage +
      nutGalacticReigns * nutGalacticReignDamage +
      deezNutGuys * deezNutGuyDamage +
      nutTimeTravels * nutTimeTravelDamage +
      nutUniversalDominations * nutUniversalDominationDamage +
      nutGods * nutGodDamage +
...
function Prestige() {
  ...
  if (tempGain >= 0.01) {
    if (
      confirm(
        "are you sure you want to delete all progress and prestige with a " +
          round(tempGain) +
          " nut bonus?",
      )
    ) {
...
function Load() {
  ...
  if (localStorage.getItem("save") !== null) {
    ...
    if (typeof savegame.nutBoyBonuses !== "undefined")
      nutBoyBonuses = savegame.nutBoyBonuses;
    if (typeof savegame.clickUpgrades !== "undefined")
      clickUpgrades = savegame.clickUpgrades;
    if (typeof savegame.clickUpgrades2 !== "undefined")
      clickUpgrades2 = savegame.clickUpgrades2;
    if (typeof savegame.clickUpgrades3 !== "undefined")
      clickUpgrades3 = savegame.clickUpgrades3;
    ...
    if (typeof savegame.allUpgrades !== "undefined")
      allUpgrades = savegame.allUpgrades;
    if (typeof savegame.nutFactories !== "undefined")
      nutFactories = savegame.nutFactories;
    if (typeof savegame.nutBanks !== "undefined") nutBanks = savegame.nutBanks;
    if (typeof savegame.nutEmpires !== "undefined")
      nutEmpires = savegame.nutEmpires;
    if (typeof savegame.nutWorldControls !== "undefined")
      nutWorldControls = savegame.nutWorldControls;
    if (typeof savegame.nutGalacticReigns !== "undefined")
      nutGalacticReigns = savegame.nutGalacticReigns;
    if (typeof savegame.deezNutGuys !== "undefined")
      deezNutGuys = savegame.deezNutGuys;
    if (typeof savegame.nutTimeTravels !== "undefined")
      nutTimeTravels = savegame.nutTimeTravels;
    if (typeof savegame.nutUniversalDominations !== "undefined")
      nutUniversalDominations = savegame.nutUniversalDominations;
    if (typeof savegame.nutGods !== "undefined") nutGods = savegame.nutGods;
    if (typeof savegame.nutAfterlives !== "undefined")
      nutAfterlives = savegame.nutAfterlives;
    if (typeof savegame.timeSinceStart !== "undefined")
      timeSinceStart = savegame.timeSinceStart;
    if (typeof savegame.totalDamage !== "undefined")
      totalDamage = savegame.totalDamage;
    if (typeof savegame.audioMuted !== "undefined")
      audioMuted = savegame.audioMuted;
    if (typeof savegame.musicMuted !== "undefined")
      musicMuted = savegame.musicMuted;
    if (typeof savegame.musicProgress !== "undefined")
      musicProgress = savegame.musicProgress;
    if (typeof savegame.nutBoyUpgradeShown !== "undefined")
      nutBoyUpgradeShown = savegame.nutBoyUpgradeShown;
    if (typeof savegame.clickUpgradeShown !== "undefined")
      clickUpgradeShown = savegame.clickUpgradeShown;
    if (typeof savegame.click2UpgradeShown !== "undefined")
      click2UpgradeShown = savegame.click2UpgradeShown;
    if (typeof savegame.click3UpgradeShown !== "undefined")
      click2UpgradeShown = savegame.click3UpgradeShown;
    if (typeof savegame.allUpgradeShown !== "undefined")
      allUpgradeShown = savegame.allUpgradeShown;
    if (typeof savegame.level !== "undefined") level = savegame.level;
    if (typeof savegame.xp !== "undefined") xp = savegame.xp;
    if (typeof savegame.nutKidDamage !== "undefined")
      nutKidDamage = savegame.nutKidDamage;
    if (typeof savegame.nutBoyDamage !== "undefined")
      nutBoyDamage = savegame.nutBoyDamage;
    if (typeof savegame.nutManDamage !== "undefined")
      nutManDamage = savegame.nutManDamage;
    if (typeof savegame.nutFarmDamage !== "undefined")
      nutFarmDamage = savegame.nutFarmDamage;
    if (typeof savegame.nutFactoryDamage !== "undefined")
      nutFactoryDamage = savegame.nutFactoryDamage;
    if (typeof savegame.nutBankDamage !== "undefined")
      nutBankDamage = savegame.nutBankDamage;
    if (typeof savegame.nutEmpireDamage !== "undefined")
      nutEmpireDamage = savegame.nutEmpireDamage;
    if (typeof savegame.nutWorldControlDamage !== "undefined")
      nutWorldControlDamage = savegame.nutWorldControlDamage;
    if (typeof savegame.nutGalacticReignDamage !== "undefined")
      nutGalacticReignDamage = savegame.nutGalacticReignDamage;
    if (typeof savegame.deezNutGuyDamage !== "undefined")
      deezNutGuyDamage = savegame.deezNutGuyDamage;
    if (typeof savegame.nutTimeTravelDamage !== "undefined")
      nutTimeTravelDamage = savegame.nutTimeTravelDamage;
    if (typeof savegame.nutUniversalDominationDamage !== "undefined")
      nutUniversalDominationDamage = savegame.nutUniversalDominationDamage;
    if (typeof savegame.nutGodDamage !== "undefined")
      nutGodDamage = savegame.nutGodDamage;
    if (typeof savegame.nutAfterlifeDamage !== "undefined")
      nutAfterlifeDamage = savegame.nutAfterlifeDamage;
    if (typeof savegame.maxNuts !== "undefined") maxNuts = savegame.maxNuts;
    if (typeof savegame.ranInvert !== "undefined")
      ranInvert = savegame.ranInvert;
  }
  ...
  if (localStorage.getItem("prestigeSave") !== null) {
    ...
    document.getElementById("prestigeGainText").innerHTML = kFormatter(
      round(prestigeGain),
    );
  }
...
function GreyOutButtons() {
  ...
  if (nuts < nutWorldControlCostNext) {
    document.getElementsByClassName(
      "buyNutWorldControl",
    )[1].style.webkitFilter = "brightness(70%)";
...
function UpdateValues() {
  ...
  if (clickUpgrades3 > 0) {
    clickDamage =
      clickUpgrades3 * (3 * (1 + clickUpgradesTemp + clickUpgrades2Temp));
  } else {
  ...
  document.getElementById("nutBoyBonusTotal").innerHTML =
    kFormatter(nutBoyDamage);
  ...
  document.getElementById("nutUniversalDominations").innerHTML =
    nutUniversalDominations;
  document.getElementById("nutGods").innerHTML = nutGods;
  document.getElementById("nutAfterlives").innerHTML = nutAfterlives;
  document.getElementById("addedNuts").innerHTML =
    "+ " + kFormatter(totalDamage);
  document.getElementById("totalDamage").innerHTML = kFormatter(totalDamage);
  document.getElementById("damageAdded").innerHTML =
    "+ " + kFormatter(totalDamage) + "/sec";

  document.getElementById("nutKidDamage").innerHTML = kFormatter(
    round(nutKidDamage),
  );
  document.getElementById("nutBoyBonusTotal").innerHTML = kFormatter(
    round(nutBoyDamage),
  );
  document.getElementById("nutManDamage").innerHTML = kFormatter(
    round(nutManDamage),
  );
  document.getElementById("nutFarmDamage").innerHTML = kFormatter(
    round(nutFarmDamage),
  );
  document.getElementById("nutFactoryDamage").innerHTML = kFormatter(
    round(nutFactoryDamage),
  );
  document.getElementById("nutBankDamage").innerHTML = kFormatter(
    round(nutBankDamage),
  );
  document.getElementById("nutEmpireDamage").innerHTML = kFormatter(
    round(nutEmpireDamage),
  );
  document.getElementById("nutWorldControlDamage").innerHTML = kFormatter(
    round(nutWorldControlDamage),
  );
  document.getElementById("nutGalacticReignDamage").innerHTML = kFormatter(
    round(nutGalacticReignDamage),
  );
  document.getElementById("deezNutGuyDamage").innerHTML = kFormatter(
    round(deezNutGuyDamage),
  );
  document.getElementById("nutTimeTravelDamage").innerHTML = kFormatter(
    round(nutTimeTravelDamage),
  );
  document.getElementById("nutUniversalDominationDamage").innerHTML =
    kFormatter(round(nutUniversalDominationDamage));
  document.getElementById("nutGodDamage").innerHTML = kFormatter(
    round(nutGodDamage),
  );
  document.getElementById("nutAfterlifeDamage").innerHTML = kFormatter(
    round(nutAfterlifeDamage),
  );

  document.getElementById("clickUpgradeDamage").innerHTML = kFormatter(
    round(clickUpgradesTemp),
  );
  document.getElementById("clickUpgrade2Damage").innerHTML = kFormatter(
    round(clickUpgrades2Temp),
  );
  document.getElementById("clickUpgrade3Damage").innerHTML = kFormatter(
    round(clickUpgrades3 * (3 * (1 + clickUpgradesTemp + clickUpgrades2Temp))),
  );

  document.getElementById("nutKidTotalDmg").innerHTML = kFormatter(
    round(nutKids * (prestigeGain + levelMultiplier * nutKidDamage)),
  );
  document.getElementById("nutBoyTotalDmg").innerHTML = kFormatter(
    round(nutBoys * (prestigeGain + levelMultiplier * nutBoyDamage)),
  );
  document.getElementById("nutManTotalDmg").innerHTML = kFormatter(
    round(nutMen * (prestigeGain + levelMultiplier * nutManDamage)),
  );
  document.getElementById("nutFarmTotalDmg").innerHTML = kFormatter(
    round(nutFarms * (prestigeGain + levelMultiplier * nutFarmDamage)),
  );
  document.getElementById("nutFactoryTotalDmg").innerHTML = kFormatter(
    round(nutFactories * (prestigeGain + levelMultiplier * nutFactoryDamage)),
  );
  document.getElementById("nutBankTotalDmg").innerHTML = kFormatter(
    round(nutBanks * (prestigeGain + levelMultiplier * nutBankDamage)),
  );
  document.getElementById("nutEmpireTotalDmg").innerHTML = kFormatter(
    round(nutEmpires * (prestigeGain + levelMultiplier * nutEmpireDamage)),
  );
  document.getElementById("nutWorldControlTotalDmg").innerHTML = kFormatter(
    round(
      nutWorldControls *
        (prestigeGain + levelMultiplier * nutWorldControlDamage),
    ),
  );
  document.getElementById("nutGalacticReignTotalDmg").innerHTML = kFormatter(
    round(
      nutGalacticReigns *
        (prestigeGain + levelMultiplier * nutGalacticReignDamage),
    ),
  );
  document.getElementById("deezNutGuyTotalDmg").innerHTML = kFormatter(
    round(deezNutGuys * (prestigeGain + levelMultiplier * deezNutGuyDamage)),
  );
  document.getElementById("nutTimeTravelTotalDmg").innerHTML = kFormatter(
    round(
      nutTimeTravels * (prestigeGain + levelMultiplier * nutTimeTravelDamage),
    ),
  );
  document.getElementById("nutUniversalDominationTotalDmg").innerHTML =
    kFormatter(
      round(
        nutUniversalDominations *
          (prestigeGain + levelMultiplier * nutUniversalDominationDamage),
      ),
    );
  document.getElementById("nutGodTotalDmg").innerHTML = kFormatter(
    round(nutGods * (prestigeGain + levelMultiplier * nutGodDamage)),
  );
  document.getElementById("nutAfterlifeTotalDmg").innerHTML = kFormatter(
    round(
      nutAfterlives * (prestigeGain + levelMultiplier * nutAfterlifeDamage),
    ),
  );
}
...
function UpdateCosts() {
  ...
  nutWorldControlCostNext = Math.floor(
    330000000 * Math.pow(1.1, nutWorldControls),
  );
  nutGalacticReignCostNext = Math.floor(
    1500000000 * Math.pow(1.1, nutGalacticReigns),
  );
  deezNutGuyCostNext = Math.floor(75000000000 * Math.pow(1.1, deezNutGuys));
  nutTimeTravelCostNext = Math.floor(
    1000000000000 * Math.pow(1.1, nutTimeTravels),
  );
  nutUniversalDominationCostNext = Math.floor(
    40000000000000 * Math.pow(1.1, nutUniversalDominations),
  );
  nutGodCostNext = Math.floor(170000000000000 * Math.pow(1.1, nutGods));
  nutAfterlifeCostNext = Math.floor(
    2000000000000000 * Math.pow(1.1, nutAfterlives),
  );
  ...
  document.getElementById("nutBoyBonusCost").innerHTML =
    kFormatter(nutBoyBonusCostNext);
  document.getElementById("clickCost").innerHTML =
    kFormatter(clickUpgradeCostNext);
  document.getElementById("clickCost2").innerHTML = kFormatter(
    clickUpgrade2CostNext,
  );
  document.getElementById("clickCost3").innerHTML = kFormatter(
    clickUpgrade3CostNext,
  );
  document.getElementById("nutManCost").innerHTML = kFormatter(nutManCostNext);
  document.getElementById("nutFarmCost").innerHTML =
    kFormatter(nutFarmCostNext);
  document.getElementById("allUpgradeCost").innerHTML =
    kFormatter(allUpgradeCostNext);
  document.getElementById("nutFactoryCost").innerHTML =
    kFormatter(nutFactoryCostNext);
  document.getElementById("nutBankCost").innerHTML =
    kFormatter(nutBankCostNext);
  document.getElementById("nutEmpireCost").innerHTML =
    kFormatter(nutEmpireCostNext);
  document.getElementById("nutWorldControlCost").innerHTML = kFormatter(
    nutWorldControlCostNext,
  );
  document.getElementById("nutGalacticReignCost").innerHTML = kFormatter(
    nutGalacticReignCostNext,
  );
  document.getElementById("deezNutGuyCost").innerHTML =
    kFormatter(deezNutGuyCostNext);
  document.getElementById("nutTimeTravelCost").innerHTML = kFormatter(
    nutTimeTravelCostNext,
  );
  document.getElementById("nutUniversalDominationCost").innerHTML = kFormatter(
    nutUniversalDominationCostNext,
  );
  document.getElementById("nutGodCost").innerHTML = kFormatter(nutGodCostNext);
  document.getElementById("nutAfterlifeCost").innerHTML =
    kFormatter(nutAfterlifeCostNext);
}
...
function UpdateLevel() {
  ...
  document.getElementById("multipliernumber").innerHTML =
    round(levelMultiplier) + "x";
}

function UpdateDamage() {
  totalDamage = round(
    (prestigeGain + levelMultiplier) *
      (nutKidDamage * nutKids +
        nutBoyDamage * nutBoys +
        nutManDamage * nutMen +
        nutFarmDamage * nutFarms +
        nutFactoryDamage * nutFactories +
        nutBankDamage * nutBanks +
        nutEmpireDamage * nutEmpires +
        nutWorldControlDamage * nutWorldControls +
        nutGalacticReignDamage * nutGalacticReigns +
        deezNutGuyDamage * deezNutGuys +
        nutTimeTravelDamage * nutTimeTravels +
        nutUniversalDominationDamage * nutUniversalDominations +
        nutGodDamage * nutGods +
        nutAfterlifeDamage * nutAfterlives),
  );
}
    ...
    if (x <= nuts) {
      if (
        confirm(
          "you selected " +
            x +
            " nuts, are you sure you want to gamble them for a 25% chance to get " +
            x * multiplyAmount +
            " back ?",
        )
      ) {
        ...
        if (randomNumber == 2) {
          ...
          alert(
            "bad luck, the random number was " +
              randomNumber +
              " and you were aiming for 2",
          );
        }
      }
    } else {
    ...
    if (x <= nuts) {
      if (
        confirm(
          "you selected " +
            x +
            " nuts, are you sure you want to gamble them for a chance to get " +
            x * 2.5 +
            " back ?",
        )
      ) {
        ...
        if (botPick == "paper" && pick == "scissors") {
          x = x * 2.5;
          alert(
            "you win, the enemy player chose paper and you chose scissors!\n" +
              x +
              " nuts gained.",
          );
          nuts = nuts + x;
          ...
          alert(
            "you lose, the enemy player chose rock and you chose scissors\n" +
              x +
              " nuts lost.",
          );
          UpdateValues();
        ...
        if (botPick == "rock" && pick == "paper") {
          x = x * 2.5;
          alert(
            "you win, the enemy player chose rock and you chose paper!\n" +
              x +
              " nuts gained.",
          );
          nuts = nuts + x;
          ...
          alert(
            "you lose, the enemy player chose scissors and you chose paper\n" +
              x +
              " nuts lost.",
          );
          x = x * multiplyAmount;
        ...
        if (botPick == "scissors" && pick == "rock") {
          x = x * 2.5;
          alert(
            "you win, the enemy player chose scissors and you chose rock!\n" +
              x +
              " nuts gained.",
          );
          nuts = nuts + x;
          ...
          alert(
            "you lose, the enemy player chose paper and you chose rock\n" +
              x +
              " nuts lost.",
          );
          UpdateValues();
