...
const Home: React.FC<HomeProps> = ({ setActiveView, navigateToAlbum, navigateToArtist, navigateToSearch, navigateToApiPlaylist, navigateToPlaylist }) => {
    ...
    useEffect(() => {
        const fetchSpotlight = async () => {
            ...
            try {
                ...
                const artistPromises = HIP_HOP_IDS.map(id => getArtistDetails(id));
                ...
                const shuffledAlbums = allAlbums.sort(() => 0.5 - Math.random()).slice(0, 15);
    ...
    const heroAlbums = newReleases.length > 0 ? newReleases : hipHopSpotlight.albums;
        ...
        <div className="text-white pb-32">
            {isLoading && !heroRelease ? (
                ...
                <div className="space-y-16">
                    ...
                    {hipHopSpotlight.artists.length > 0 && (
                    ...
                    {hipHopSpotlight.songs.length > 0 && (
                        <div className="animate-in fade-in slide-in-from-bottom-8 duration-700 delay-300">
