        ...
        content: (
          <>
              <div className="space-y-4 text-gray-300 mb-6 mt-4">
                  <input type="text" defaultValue={newName} onChange={e => newName = e.target.value} className="w-full bg-white/10 p-3 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#3A8FE0]" placeholder={t('playlistView.playlistName')} />
                  <textarea rows={3} defaultValue={newDesc} onChange={e => newDesc = e.target.value} className="w-full bg-white/10 p-3 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#3A8FE0]" placeholder={t('playlistView.description')} />
              </div>
              <div className="flex justify-end space-x-4">
                   ...
                   <button onClick={() => { updatePlaylist(playlist.id, { name: newName, description: newDesc }); hideModal(); }} className="px-6 py-2 rounded-lg bg-[#3A8FE0] text-white font-bold shadow-lg shadow-[#3A8FE0]/20">{t('playlistView.save')}</button>
              </div>
          </>
        )
      });
