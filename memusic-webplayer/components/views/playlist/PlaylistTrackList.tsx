                ...
                {isSortMenuOpen && (
                  <div className="absolute top-full right-0 mt-2 w-40 bg-[#163A6B] border border-white/10 rounded-lg shadow-2xl p-2 z-30">
                    <button
                      ...
                      className={`w-full text-left px-3 py-2 text-sm rounded-md hover:bg-white/10 ${sortKey === "default" ? "text-[#3A8FE0]" : ""}`}
                    >
                      Default
                    </button>
                    <button
                      ...
                      className={`w-full text-left px-3 py-2 text-sm rounded-md hover:bg-white/10 ${sortKey === "title" ? "text-[#3A8FE0]" : ""}`}
                    >
                      Title
                    </button>
                    <button
                      ...
                      className={`w-full text-left px-3 py-2 text-sm rounded-md hover:bg-white/10 ${sortKey === "duration" ? "text-[#3A8FE0]" : ""}`}
                    >
                      Duration
                    </button>
                  </div>
