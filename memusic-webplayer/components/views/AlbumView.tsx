                ...
                content: (
                  <div className="space-y-2">
                    ...
                    <div className="w-full bg-gray-600 rounded-full h-2.5">
                      <div className="bg-[#3A8FE0] h-2.5 rounded-full" style={{ width: `${(filesAdded / totalFiles) * 100}%` }}></div>
                    </div>
                  </div>
                ),
            });
            ...
            content: (
              <div className="space-y-2">
                <p>{t('albumView.downloadCompressingProgress', { percent: metadata.percent.toFixed(0) })}</p>
                 <div className="w-full bg-gray-600 rounded-full h-2.5">
                    <div className="bg-[#3A8FE0] h-2.5 rounded-full" style={{ width: `${metadata.percent}%` }}></div>
                </div>
              </div>
            ),
        });
