...
export const CinematicHeader: React.FC<CinematicHeaderProps> = ({
    ...
    return (
        <div ref={containerRef} className="relative w-full">
            <div className={`fixed top-0 left-0 right-0 z-40 md:pl-64 h-20 bg-[#0B1E3D]/90 backdrop-blur-2xl border-b border-white/5 flex items-center justify-between px-6 transition-all duration-500 transform ${isScrolled ? 'translate-y-0 opacity-100' : '-translate-y-full opacity-0'}`}>
                ...
                <div className="flex items-center gap-2">
                    <button onClick={onToggleFavorite} className={`p-2.5 rounded-full bg-white/5 hover:bg-white/10 transition-all active:scale-95 ${isFavorite ? 'text-[#3A8FE0]' : 'text-gray-400'}`}>
            ...
            <div className="relative w-full overflow-hidden group">
                ...
                <div className="absolute inset-0 z-0 h-[85vh] select-none pointer-events-none overflow-hidden">
                    <div 
                        ...
                        style={{ backgroundImage: imageUrl ? `url(${imageUrl})` : undefined, backgroundColor: '#0B1E3D' }}
                    />
                ...
                <div className="relative z-10 px-6 md:px-12 pb-6">
                    <div className="inline-flex items-center p-2 pr-6 rounded-[2rem] bg-white/5 border border-white/5 backdrop-blur-xl shadow-xl hover:bg-white/10 transition-colors duration-300 gap-4">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            >
                                <HeartIcon className={`w-7 h-7 transition-all duration-300 ${isFavorite ? 'fill-[#3A8FE0] text-[#3A8FE0] drop-shadow-[0_0_10px_rgba(58,143,224,0.5)]' : 'text-gray-300 group-hover/fav:text-white'}`} />
                            </button>
