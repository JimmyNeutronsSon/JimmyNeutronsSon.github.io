    ...
    const OptionCard: React.FC<{
        ...
        <button
         ...
         >
            ...
            <div className={`w-16 h-16 mb-5 flex items-center justify-center rounded-2xl transition-colors duration-200 ${isSelected ? 'bg-[#3A8FE0] text-white' : 'bg-white/10 text-gray-400 group-hover:text-white'}`}>
        ...
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-300 ease-out text-center">
            ...
            <div className="mb-8">
                ...
                >
                    ...
                    <div className={`absolute inset-0 bg-[#3A8FE0] rounded-2xl flex items-center justify-center text-black font-bold text-lg transition-opacity duration-200 ${copied === 'code' ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
    ...
    return (
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-300 ease-out">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <button onClick={() => setView('create')} className="flex flex-col items-center p-8 rounded-3xl bg-[#163A6B] border border-white/5 hover:border-[#3A8FE0]/50 hover:bg-[#2f2f2f] transition-all duration-300 group text-center transform active:scale-[0.98] shadow-lg hover:shadow-xl">
                 ...
                 <button onClick={() => setView('join')} className="flex flex-col items-center p-8 rounded-3xl bg-[#163A6B] border border-white/5 hover:border-white/30 hover:bg-[#2f2f2f] transition-all duration-300 group text-center transform active:scale-[0.98] shadow-lg hover:shadow-xl">
