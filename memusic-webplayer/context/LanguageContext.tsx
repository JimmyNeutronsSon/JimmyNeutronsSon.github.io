...
const en: Translations = {
  ...
  settings: {
    ...
    data: {
      title: "Manage Data",
      description: "Back up your library to a file, or restore from a backup.",
  ...
  modals: {
    partyEnded: {
      ...
      connectionLost: 'Connection to the host of party "{{partyId}}" was lost.',
...
export const LanguageProvider: React.FC<LanguageProviderProps> = ({
  ...
  const t = useCallback(
    (
      ...
      let translation = resolveKey(currentTranslations, key);
      if (replacements) {
