      ...
      return (
        <div className="h-screen w-screen bg-[#0B1E3D] text-white flex flex-col items-center justify-center p-8 text-center font-sans glass-panel">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <button onClick={this.handleReset} className="px-6 py-3 rounded-full bg-[#1E6CC7] text-white font-bold hover:bg-[#3A8FE0] transition-colors shadow-lg shadow-blue-500/20">
              Reset App & Reload
            </button>
          </div>
           {this.state.error && (
      ...
      <div className="relative h-screen w-screen overflow-hidden text-gray-200 font-sans selection:bg-[#3A8FE0] selection:text-white">
        ...
        <Modal isOpen={!!partyEndedMessageText} onClose={clearPartyEndedMessage} title={t('modals.partyEnded.title')}>
          ...
          <div className="flex justify-end">
              <button onClick={clearPartyEndedMessage} className="px-6 py-2 rounded-full bg-[#1E6CC7] text-white font-bold hover:bg-[#3A8FE0] transition-colors shadow-lg shadow-blue-500/20">{t('modals.partyEnded.ok')}</button>
          </div>
        </Modal>
      </div>
